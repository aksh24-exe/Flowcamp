...
**Product Name:** Flowcamp Backend  
**Version:** 1.0.0  
**Product Type:** Backend API for Project Management System

Flowcamp Backend is a RESTful API service designed to support collaborative project management. The system enables teams to organize projects, manage tasks with subtasks, maintain project notes, and handle user authentication with role-based access control.
